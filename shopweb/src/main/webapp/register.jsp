...
<html>
	...
	<body>
		...
		<jsp:include page="model/header1.jsp"></jsp:include>
			...
			<div class="head">
				<div class="logo-zc">
				<a href="index"><img src="img/images/logojgj_03.png"/></a>
			    </div>
			    <span class="welcome">
				        欢迎注册
			    </span>
			...
			<div class="cont-zc">
				...
				<ul>
					...
					<li>
						<label>手机号</label>
						<input class="two" type="text" name="tel" value=""placeholder="可用于登陆和找回密码"/>
					...
					<li>
						<label>密码</label>
						<input class="four"type="password" value=""placeholder="请设置登录密码"/>
						<span>长度为6~14个字符<br />支持数字，大小写字母和标点符号<br />不允许有空格</span>
					</li>
					<li>
						<input class="five"type="checkbox" name=""  />
						<p class="yuedu">阅读并接受<em class="xieyi">《鲜生购用户注册协议》</em></p>
					</li>
					<li>
						<a href="#"><input class="six"type="button" onclick="" value="注册"/></a>
					</li>
			</ul>
				</form>
			</div>
