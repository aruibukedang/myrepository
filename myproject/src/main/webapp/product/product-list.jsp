...
<div style="margin-left:200px;">
   ...
   <tr class="text-c va-m ">
					...
					<i class="Hui-iconfont">&#xe6de;</i></a>
					 ...
					 <a style="text-decoration:none" class="ml-5" onClick="product_del(${r.id})" href="javascript:;" title="删除">
					 <i class="Hui-iconfont">&#xe6e2;</i></a>
					 </td>
				</tr>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="../m1/lib/zTree/v3/js/jquery.ztree.all-3.5.min.js"></script>
