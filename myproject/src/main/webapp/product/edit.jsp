...
<link href="../m1/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
...
<div class="page-container">
  ...
  <form action="insert" method="post" class="form form-horizontal" id="form-article-add"  >	
</c:if>
 	<c:if test="${requestScope.info!=null}">
 	<form action="update" method="post" class="form form-horizontal" id="form-article-add" >	
	<input type="hidden" name="id" value="${requestScope.info.id}">	
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${requestScope.info.fullname}"  name="fullname">
			</div>
		</div>
  ...
  <option selected="selected" value="${r.id}">${r.name}</option>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">状态选择：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
	...
	<option selected="selected" value="${v.index}">${r}</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="tip" id=""  value="${requestScope.info.tip}" class="input-text">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="activity" id=""  value="${requestScope.info.activity}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">促销信息</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="sale" id=""  value="${requestScope.info.sale}" class="input-text">
			</div>
		</div>
	...
	<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="comments" id=""  value="${requestScope.info.comments}" class="input-text">
			</div>
		</div>
	...
	<%-- 	<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="info" id=""  value="${requestScope.info.info}" class="input-text">
			</div>
		</div>
		 --%>
		...
		<div class="row cl">
			...
			<div style="height: 100%; float: left; margin-left: 160px" >
			
			图片上传：
			
			</div>
			<div   class="picList formControls col-xs-8 col-sm-9" name="pics"  width="600"  height="300" rows="2" cols="5" >
	...
	<br>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="save();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 保存并提交</button>
...
<script type="text/javascript" src="../m1/lib/webuploader/0.1.5/webuploader.min.js"></script> 
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            dnd: '#dndArea',
            paste: '#uploader',
            swf: '../m1/lib/webuploader/0.1.5/Uploader.swf',
            chunked: false,
            chunkSize: 512 * 1024,
            server: '../m1/lib/webuploader/0.1.5/server/fileupload.php',
            // runtimeOrder: 'flash',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('../m1/lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
